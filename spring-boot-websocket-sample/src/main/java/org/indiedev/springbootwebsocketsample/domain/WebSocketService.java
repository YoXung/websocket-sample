package org.indiedev.springbootwebsocketsample.domain;

import org.indiedev.sample.config.WebSocketEndpointConfigure;
 ...
 */
@Component
@ServerEndpoint(value = "/webSocketSample/{id}", configurator = WebSocketEndpointConfigure.class)
